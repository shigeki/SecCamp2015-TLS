...
var SecCampTLS = require('../index.js');
var fs = require('fs');
...
var iv = Buffer.concat([keyblock.server_write_IV, nonce_explicit]);
var aad = Buffer.concat([read_seq, record_header]);
// Decrypt Application Data
var decipher = crypto.createDecipheriv('aes-128-gcm', keyblock.server_write_key, iv);
